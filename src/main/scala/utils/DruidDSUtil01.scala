...
import utils.MysqlConnection.source

/**
 * @author jiangfan
 * @date 2022/10/11 10:32
 */
object DruidDSUtil01 {
  private var druidDataSource:DruidDataSource = createDataSource()

  def createDataSource(): DruidDataSource = { // 创建连接池
    println(" 创建连接池")
    ...
    druidDataSource.setRemoveAbandonedTimeout(240)
