...
//    val streamFile: DataStream[String] = env.readTextFile(path)
        ...
        println("=================begin====================")
        val streamFile: DataStream[String] = env.addSource(new FlinkKafkaConsumer[String]("sensor02", new SimpleStringSchema(), properties))
    ...
    dataStream.addSink( new FlinkKafkaProducer[String]("localhost:9092","sinkTest02",new SimpleStringSchema()))
    dataStream.print()
