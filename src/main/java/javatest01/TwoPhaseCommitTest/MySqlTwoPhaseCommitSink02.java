 ...
 */
//public class MySqlTwoPhaseCommitSink02 {
//}

public class MySqlTwoPhaseCommitSink02 extends TwoPhaseCommitSinkFunction<String,
        MySqlTwoPhaseCommitSink02.ConnectionState, Void> {

//    private static final Object VoidSerializer = ;

    // 定义可用的构造函数
    public MySqlTwoPhaseCommitSink02() {
        super(new KryoSerializer<>(MySqlTwoPhaseCommitSink02.ConnectionState.class, new ExecutionConfig()),
    ...
    @Override
    protected void invoke(ConnectionState transaction, String value, Context context) throws Exception {
